import numpy as np
from SystemOfEquations.AlternatingProjections import simulate as simulate_ap
from SystemOfEquations.DouglasRachford import simulate as simulate_dr
from SystemOfEquations.Nesterov import nesterov
from ReadMatrix import readMatFile
from FindFiles import findFilesWithEnding
import os

def generateEqualsRuns(inputFolder, outputFolder, numIterations):
